        ...
        <UserGuidePanel isOpen={isGuideOpen} onClose={() => setIsGuideOpen(false)} title="Products Catalogue" desc="ระบบจัดการแคตตาล็อกสินค้า">
            <section className="animate-fadeIn mt-6">
                ...
                <div className="space-y-3 font-medium bg-[#f8f9fa] p-4 rounded-xl border border-[#daecf3] shadow-sm text-[12px]">
                    <div className="flex items-center gap-3"><button className="bg-[#cc0000] text-white px-3 py-1 rounded-full text-[10px] font-black uppercase shadow-sm flex items-center gap-1"><Icons.Plus size={12}/> New Product</button> <span className="text-[11px] text-[#214573]">เพิ่มรายการสินค้าใหม่ลงในแคตตาล็อก</span></div>
                    <div className="flex items-center gap-3"><div className="relative"><Icons.Search size={12} className="absolute left-2 top-1.5 text-[#a3c2d2]"/><input placeholder="Search..." className="pl-6 py-1 text-[10px] bg-white border border-[#daecf3] rounded-full w-20 pointer-events-none"/></div> <span className="text-[11px] text-[#214573]">ค้นหาสินค้าด้วยชื่อ บาร์โค้ด หรือ รหัส SKU</span></div>
                    <div className="flex items-center gap-3"><button className="w-8 h-8 flex items-center justify-center bg-white text-[#af7a2b] border border-[#daecf3] rounded-lg shadow-sm"><Icons.Edit size={14}/></button> <button className="w-8 h-8 flex items-center justify-center bg-white text-[#fe424d] border border-[#daecf3] rounded-lg shadow-sm"><Icons.Trash2 size={14}/></button> <span className="text-[11px] text-[#214573]">แก้ไข หรือ ลบ สินค้าในตาราง</span></div>
                </div>
            </section>
        </UserGuidePanel>
